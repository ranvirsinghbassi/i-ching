...
<style>
  *,*::before,*::after{box-sizing:border-box}
  ...
  html{font-size:115%}
  body{font-family:'Patrick Hand',cursive;background:#FAFAFA;color:var(--text-black);margin:0;padding:0 1.5rem 4rem;display:flex;flex-direction:column;align-items:center}
